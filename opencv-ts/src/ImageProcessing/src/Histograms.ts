...
type HISTCMP_CORREL = 0;
type HISTCMP_CHISQR = 1;
type HISTCMP_INTERSECT = 2;
type HISTCMP_BHATTACHARYYA = 3;
type HISTCMP_HELLINGER = HISTCMP_BHATTACHARYYA;
type HISTCMP_CHISQR_ALT = 4;
type HISTCMP_KL_DIV = 5;

export type HistCompMethods =
    | HISTCMP_CORREL
    | HISTCMP_CHISQR
    | HISTCMP_INTERSECT
...
export interface IHistCompMethods {
    ...
    HISTCMP_CHISQR_ALT: HISTCMP_CHISQR_ALT;
