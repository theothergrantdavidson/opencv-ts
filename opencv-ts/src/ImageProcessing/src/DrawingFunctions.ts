...
type FONT_HERSHEY_SIMPLEX = 0;
type FONT_HERSHEY_PLAIN = 1;
type FONT_HERSHEY_DUPLEX = 2;
type FONT_HERSHEY_COMPLEX = 3;
type FONT_HERSHEY_TRIPLEX = 4;
type FONT_HERSHEY_COMPLEX_SMALL = 5;
type FONT_HERSHEY_SCRIPT_SIMPLEX = 6;
type FONT_HERSHEY_SCRIPT_COMPLEX = 7;
type FONT_ITALIC = 16;

export type HersheyFonts =
...
export interface IHersheyFonts {
    ...
    FONT_HERSHEY_TRIPLEX: FONT_HERSHEY_SIMPLEX;
    FONT_HERSHEY_COMPLEX_SMALL: FONT_HERSHEY_SIMPLEX;
    FONT_HERSHEY_SCRIPT_SIMPLEX: FONT_HERSHEY_SIMPLEX;
    FONT_HERSHEY_SCRIPT_COMPLEX: FONT_HERSHEY_SIMPLEX;
    FONT_ITALIC: FONT_HERSHEY_SIMPLEX;
}
...
export type LineTypes = FILLED | LINE_4 | LINE_8 | LINE_AA;

export interface ILineTypes {
    FILLED: FILLED;
    LINE_4: LINE_4;
    LINE_8: LINE_8;
    LINE_AA: LINE_AA;
...
type MARKER_CROSS = 0;
type MARKER_TILTED_CROSS = 1;
type MARKER_STAR = 2;
type MARKER_DIAMOND = 3;
type MARKER_SQUARE = 4;
type MARKER_TRIANGLE_UP = 5;
type MARKER_TRIANGLE_DOWN = 6;
...
export interface DrawingFunctions {
     ...
     * @param fontFace Font to use, see
     ...
     * @param color Line color
     * @param thickness Line thickness
     * @param lineType Type of the line. See
     * @param shift Number of fractional bits in the point coordinates
     */
    line(
        img: Mat,
