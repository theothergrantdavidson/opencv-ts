...
import { Moments } from "../../core/src/Moments";
...
export interface IConnectedComponentsAlgorithmsTypes {
    CCL_DEFAULT: CCL_DEFAULT;
    CCL_WU: CCL_WU;
    CCL_GRANA: CCL_GRANA;
    CCL_BOLELLI: CCL_BOLELLI;
    CCL_SAUF: CCL_SAUF;
    CCL_BBDT: CCL_BBDT;
    CCL_SPAGHETTI: CCL_SPAGHETTI;
}

type CC_STAT_LEFT = 0;
type CC_STAT_TOP = 1;
type CC_STAT_WIDTH = 2;
type CC_STAT_HEIGHT = 3;
type CC_STAT_AREA = 4;
...
export interface IConnectedComponentsTypes {
    CC_STAT_LEFT: CC_STAT_LEFT;
    CC_STAT_TOP: CC_STAT_TOP;
    CC_STAT_WIDTH: CC_STAT_WIDTH;
    CC_STAT_HEIGHT: CC_STAT_HEIGHT;
    CC_STAT_AREA: CC_STAT_AREA;
}

type CHAIN_APPROX_NONE = 1;
type CHAIN_APPROX_SIMPLE = 2;
type CHAIN_APPROX_TC89_L1 = 3;
type CHAIN_APPROX_TC89_KCOS = 4;
...
export interface IContourApproximationModes {
...
type INTERSECT_NONE = 0;
type INTERSECT_PARTIAL = 1;
type INTERSECT_FULL = 2;

export type RectanglesIntersectTypes = INTERSECT_NONE | INTERSECT_PARTIAL | INTERSECT_FULL;

export interface IRectanglesIntersectTypes {
    INTERSECT_NONE: INTERSECT_NONE;
    INTERSECT_PARTIAL: INTERSECT_PARTIAL;
    INTERSECT_FULL: INTERSECT_FULL;
}

type RETR_EXTERNAL = 0;
type RETR_LIST = 1;
type RETR_CCOMP = 2;
type RETR_TREE = 3;
type RETR_FLOODFILL = 4;

export type RetrievalModes = RETR_EXTERNAL | RETR_LIST | RETR_CCOMP | RETR_TREE | RETR_FLOODFILL;

export interface IRetrievalModes {
...
type CONTOURS_MATCH_I1 = 1;
type CONTOURS_MATCH_I2 = 2;
type CONTOURS_MATCH_I3 = 3;

export type ShapeMatchModes = CONTOURS_MATCH_I1 | CONTOURS_MATCH_I2 | CONTOURS_MATCH_I3;

export interface IShapeMatchModes {
    CONTOURS_MATCH_I1: CONTOURS_MATCH_I1;
    CONTOURS_MATCH_I2: CONTOURS_MATCH_I2;
    CONTOURS_MATCH_I3: CONTOURS_MATCH_I3;
}

export interface StructuralAnalysisShapeDescriptors {
    /**
