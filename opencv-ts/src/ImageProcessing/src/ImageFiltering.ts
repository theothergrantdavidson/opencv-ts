import { BorderTypes } from '../../core/src/CoreArray';
import { DataTypes, IDataTypes } from '../../core/src/HalInterface';
...
type MORPH_RECT = 'MORPH_RECT';
type MORPH_CROSS = 'MORPH_CROSS';
type MORPH_ELLIPSE = 'MORPH_ELLIPSE';

export type MorphShapes = MORPH_RECT | MORPH_CROSS | MORPH_ELLIPSE;

export interface IMorphShapes {
    MORPH_RECT: MORPH_RECT;
    MORPH_CROSS: MORPH_CROSS;
    MORPH_ELLIPSE: MORPH_ELLIPSE;
}

type MORPH_ERODE = 'MORPH_ERODE';
type MORPH_DILATE = 'MORPH_DILATE';
type MORPH_OPEN = 'MORPH_OPEN';
type MORPH_CLOSE = 'MORPH_CLOSE';
type MORPH_GRADIENT = 'MORPH_GRADIENT';
type MORPH_TOPHAT = 'MORPH_TOPHAT';
type MORPH_BLACKHAT = 'MORPH_BLACKHAT';
type MORPH_HITMISS = 'MORPH_HITMISS';
...
type FILTER_SCHARR = 'FILTER_SCHARR';

export type SpecialFilter = FILTER_SCHARR;

export interface ISpecialFilter {
    FILTER_SCHARR: FILTER_SCHARR;
}

export interface ImageFiltering {
    /**
    ...
    getDerivKernels(
        ...
        dx: number,
        dy: number,
        ksize: 1 | 3 | 5 | 7 | ISpecialFilter['FILTER_SCHARR'],
        normalize: boolean,
        ktype: IDataTypes['CV_32F'] | IDataTypes['CV_64F']
    ): void;
    /**
     *
