import { DataTypes } from './array-types';
import { DecompTypes } from './decomp-types';
...
export declare class Mat {
    constructor(mat: Mat);
    constructor(rows: number, cols: number, type: DataTypes, s?: Scalar);
     ...
     */
    static zeroes(size: Size, type: DataTypes): Mat;
    /**
     * The method returns a Matlab-style zero array initializer. It can be used to quickly form a constant
     * array as a function parameter, part of a matrix expression, or as a matrix initializer:
     ...
     * @returns Returns a zero array of the specified size and type.
     */
    static zeroes(rows: number, cols: number, type: DataTypes): Mat;
    /**
